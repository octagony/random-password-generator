...
const AlertBox = ({ alertStatus, setAlertStatus }: IAlertBox) => {
  ...
  return (  
    alertStatus.show && (
      <div className="absolute text-center text-accent text-2xl z-10 top-[3%] left-[25%] w-2/4 outline-none overflow-x-hidden overflow-y-auto bg-primary border-4 rounded-xl border-accent cursor-pointer" aria-hidden="true" onClick={() => setAlertStatus({...alertStatus, show:false})}>
